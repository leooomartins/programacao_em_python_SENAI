...
btn_soma =  tk.Button(fr2, text='x', font=('Montserrat', 12), bg = '#FF0909', width=12, command=mult)
btn_soma.grid(row=5, column=1, pady=20)

btn_soma =  tk.Button(fr2, text='/', font=('Montserrat', 12), bg = '#FF0909', width=12, command=div)
btn_soma.grid(row=5, column=3, pady=20)
